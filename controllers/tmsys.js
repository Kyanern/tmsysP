...
router.use(async (req, res, next) => {
    ...
    req.body.isProjectManager = await checksModel.checkGroup(req.session.username, 'projectManager');
    req.body.isTeamMember = await checksModel.checkGroup(req.session.username, 'teamMember');
    next();
});
